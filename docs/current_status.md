...
- Local executor bundles under `data/raw/manual/quantum_phase2_artifacts/` are `~16 GiB`, ignored by Git, and documented in `docs/local_large_artifacts.md`.

### Governance DFT backlog batching

- Governance DFT backlog: `1350` rows = `135` substances × `10` requested high-level QM outputs.
- Current mapping: `62` mapped governance substances and `73` unmapped substances preserved in `data/raw/generated/governance_dft_mapping_report.csv` and `data/raw/generated/governance_phase2_mapping_report.csv`.
...
- Residual cycle backend pass: `21` `run_cycle` queue entries attempted with backend `auto`; `4` CoolProp successes wrote `16` rows to `data/raw/manual/cycle_backend_results.csv`, while `17` entries remain blocked on REFPROP/root/backend coverage.
...
- `data/bronze/stage_run_manifest.parquet`
...
- `data/raw/generated/governance_xtb_requests_batch001.csv`
- `data/raw/generated/governance_xtb_xyz_manifest_batch001.csv`
- `data/raw/generated/governance_dft_singlepoint_requests_batch001.csv`
- `data/raw/generated/governance_dft_singlepoint_requests_batch002.csv`
- `data/raw/generated/governance_dft_singlepoint_xyz_manifest_batch001.csv`
- `data/raw/generated/governance_dft_singlepoint_xyz_manifest_batch002.csv`
- `data/raw/generated/governance_dft_mapping_report.csv`
- `data/raw/generated/governance_dft_mapping_summary.json`
- `data/raw/generated/governance_phase2_summary.json`
- `data/raw/generated/governance_phase2_mapping_report.csv`
- `data/raw/generated/governance_phase2_blockers.csv`
- `data/raw/generated/governance_phase2_xtb_hessian_requests.csv`
- `data/raw/generated/governance_phase2_xtb_hessian_xyz_manifest.csv`
- `data/raw/generated/governance_phase2_crest_requests.csv`
- `data/raw/generated/governance_phase2_crest_xyz_manifest.csv`
- `data/raw/generated/governance_phase2_orca_optfreq_smoke_requests.csv`
- `data/raw/generated/governance_phase2_orca_optfreq_smoke_xyz_manifest.csv`
- `data/raw/generated/governance_phase2_orca_optfreq_batch*.csv`
- `data/raw/generated/governance_phase2_orca_optfreq_xyz_manifest_batch*.csv`

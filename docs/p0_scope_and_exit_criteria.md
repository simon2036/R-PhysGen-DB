...
1. `methods/` 中仍混有研究蓝图、演示原型和正式 ingest bundle；
...
- `docs/p0_scope_and_exit_criteria.md`
- `docs/p0_phase2_interfaces_draft.md`
- `docs/p0_pipeline_stage_refactor_plan.md`
- `docs/p0_validation_rules_draft.md`
- `docs/p0_review_response_matrix.md`
...
- `methods/` 的 reference/prototype/ingested bundle 边界在 README 或 docs 中明确；
